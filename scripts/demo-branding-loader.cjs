...
module.exports = function(source) {
  ...
  return source
    ...
    .replaceAll('Production Workspace', 'Presentation Workspace')
    .replaceAll('Production Configuration', 'Demo Configuration')
    .replaceAll('Retrieving the encrypted session and cloud workspace…', 'Loading the fictional browser-local presentation workspace…')
