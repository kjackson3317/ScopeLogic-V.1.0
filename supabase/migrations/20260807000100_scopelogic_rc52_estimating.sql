-- ScopeLogic v1.0 RC5.2 — Quote Builder and Estimating Database
-- Persists parts, labor rates, and project quotes in the user-scoped estimating_data JSONB document.

alter table public.user_settings
  add column if not exists estimating_data jsonb not null default '{"laborRates":[],"parts":[],"quotesByProject":{}}'::jsonb;

comment on column public.user_settings.estimating_data is
  'User-scoped estimating database containing labor rates, parts catalog, and project quotes.';
