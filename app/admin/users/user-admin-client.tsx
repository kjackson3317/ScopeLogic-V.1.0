...
export default function UserAdminClient() {
  ...
  const deleteUser = async (user: ManagedUser) => {
    ...
    if (!window.confirm(`Delete ${user.email}? This removes the login and its project assignments. You can recreate the user afterward.`)) return;
